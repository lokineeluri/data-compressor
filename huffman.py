...
#compression: path  ->  file  ->  freqdist  ->  heap  ->  binary tree  ->  huffman code  -> encoded text     ->  binary file
    ...
    def compression(self):
        ...
        with open (self.path,'r+') as file , open(output_path,'wb') as output:
            ...
            #encoded_text contains the Huffman-encoded binary string generated from the original text. 
            #

            #padding of text 
            #Pads the encoded text to ensure it's a multiple of 8 bits.
            ...
            #to write this binary data to a file, it needs to be converted into bytes.
